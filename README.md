This project demonstrates the use of different Conflict-Based Search (CBS) algorithms to find collision-free paths for multiple agents in a maze-like grid.
